...
<head>
 ...
 <body id="mimin" class="dashboard">
      ...
      <div class="container-fluid mimin-wrapper">
           <!-- start:Left Menu -->
		     <?php require("cfg_menu_izquierdo_verificar.php"); ?>
		    <!-- end:Left Menu -->
			<!-- start: content -->
            <div id="content">
						...
						<div class="col-md-12 padding-0">
								...
								<a href="#" >
									<div class="panel box-v1">
										...
										<div class="panel-body text-left" style="margin-top:-20px">
											<h1><strong>Auditorias</strong></h1>
											<p>Registro de Auditorias</p>
										</div>
									</div>
								</a>
							</div>
							<div class="col-md-3">
								...
								<div class="panel box-v1">
									...
									<div class="panel-body text-left" style="margin-top:-20px">
										<h1><strong>Inspecciones</strong></h1>
							...
							<div class="col-md-3">
								<div class="panel box-v1">
									...
									<div class="panel-body text-left" style="margin-top:-20px">
										<h1><strong>Logros</strong></h1>
										<p>Analisis, Patrones, etc.</p>
									</div>
								</div>
							</div>
							<div class="col-md-3">
