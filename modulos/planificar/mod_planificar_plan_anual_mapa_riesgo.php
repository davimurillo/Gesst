                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown">
                          <a href="index.php">Dashboard Planificar</a> <span class="fa-angle-right fa"></span> Mapa de Riesgo
                        </p>
                    </div>
                  </div>
            </div>
              ...
              <div class="col-md-12 top-10 padding-0">
                <div class="col-md-12">
				  ...
				  <div class="panel-heading" align="right">
						<h4><a href="mod_planificar_plan_anual_mapa_riesgo_registro.php" class="btn btn-lg btn-info"><i class="fa fa-file-text-o"></i> Nuevo Mapa</a>
						</h4>
					</div>
                    <div class="panel-body">
